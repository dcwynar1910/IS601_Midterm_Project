...
class TestPower(BaseOperationTest):
    ...
    invalid_test_cases = {
        "negative_exponent": {
            ...
            "b": "-3",
            "error": ValidationError,
            "message": "Negative power is not allowed"
        },
    }
...
class TestRoot(BaseOperationTest):
    ...
    invalid_test_cases = {
        "negative_base": {
            ...
            "b": "2",
            "error": ValidationError,
            "message": "Root of negative number is not allowed"
        },
        "zero_root": {
            "a": "9",
            "b": "0",
            "error": ValidationError,
            "message": "Degree of zero is not allowed"
        },
    }
...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        "standard": {"a": "10", "b": "3", "expected": "1"},
        "no_remainder": {"a": "10", "b": "5", "expected": "0"},
...
class TestIntegerDivision(BaseOperationTest):
    ...
    valid_test_cases = {
        "standard": {"a": "10", "b": "2", "expected": "5"},
        "remainder": {"a": "10", "b": "3", "expected": "3"},
        "no_remainder": {"a": "1", "b": "5", "expected": "0"},
    }
    invalid_test_cases = {
        "zero_divide": {
            "a": "9",
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "standard": {"a": "50", "b": "100", "expected": "50"},
        "half": {"a": "10", "b": "20", "expected": "50"},
        "zero": {"a": "0", "b": "10", "expected": "0"},
    }
    invalid_test_cases = {
        "division_zero": {
            "a": "10",
            "b": "0",
            "error": ValidationError,
            "message": "Division by zero is not allowed in calculating percentage"
        },

    }

class TestAbsolute_Difference(BaseOperationTest):
    """Test Multiplication operation."""
